...
export class Shader
{
	...
	//From webGL fundamentals, To help with the obj and ply files if need makes rendering faster by enabling reuse of vertices.
	...
	drawElements(indl, mode=this.gl.TRIANGLES)
	{
		this.gl.drawElements(mode, indl, this.gl.UNSIGNED_SHORT, 0);
	} 	
